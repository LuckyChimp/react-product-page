			...
			<div className='product-details'>
				...
				<div className='product-controls-container'>
					<div className='product-amount-control'>
						<button className='product-amount-control-decrease' onClick={() => onAmountControlClick(-1)}>
							-
						</button>
						<span className='product-amount-control-display'>{product.amount}</span>
						<button className='product-amount-control-increase' onClick={() => onAmountControlClick(+1)}>
							+
						</button>
					</div>
					<button
